...
| --- | --- | --- |
| [GGSel Seller](ggsel/) | `ggsel.seller@1.2.5` | New purchases, buyer messages, replies and product catalog |
| [FunPay](funpay-cardinal/) | `funpay.cardinal@1.3.5` | Orders, status changes, messages, replies and buyer input |
